...
const suggestedItems = [
    { id: '1', title: 'Modern Sofa', image: require('../../assets/images/recommended.png') },
    { id: '2', title: 'Elegant Table', image: require('../../assets/images/recommended-2.png') },
    { id: '3', title: 'Lamp Set', image: require('../../assets/images/recommended-1.png') },
];

const nearbyStores = [
    { id: '1', title: 'Daze', image: require('../../assets/images/Daze.png') },
    { id: '2', title: 'The Concept', image: require('../../assets/images/Concept.png') },
    { id: '3', title: 'Home Decor', image: require('../../assets/images/HomeH.png') },
];
